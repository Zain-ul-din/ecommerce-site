        ...
        >
          ...
          <Popover variant={"ghost"}>
            ...
            <PopoverContent>
              <PopoverHeader>
                <Center>
                  <Text fontSize={"1xl"} fontWeight={"bold"} m={2}>
                    Shoping Cart
                  </Text>
                </Center>
              </PopoverHeader>
              <PopoverBody>
                <Stack>
                  <Stack
                    maxH={"60vh"}
                    overflowY={"scroll"}
                    className={"cartScroll"}
                  >
                    {cartContext.products &&
                      cartContext.products.map((product, idx) => (
                        <CartMeta
                          key={idx}
                          product={product}
                          context={cartContext}
                  ...
                  >
                    ...
                    {(() => {
                      let total = 0;
                      cartContext.products &&
                        cartContext.products.forEach(
                          (pro_total) =>
                            (total += isNaN(parseInt(pro_total.totalBill))
                              ? 0
                              : parseInt(pro_total.totalBill))
                        );
                      return total;
                    })()}{" "}
                    PKR
                  ...
                  <Linker href={"/user/checkout/"}>
                    <Button colorScheme={`whatsapp`} p={2} m={2}>
                      Check Out
                    </Button>
                  </Linker>
                </Stack>
                  ...
                  <>
                    ...
                    <PopoverBody w={"100%"} p={2} px={5}>
                      <Flex align={"center"} w={"100%"}>
                        ...
                        <Stack p={2} spacing={0}>
                          <Text px={2}>
                            <Badge size={"xs"} px={3} color="black">
                              {user.user.name}
                            </Badge>
                          </Text>
                          <Text
    ...
    <>
      <Popover trigger={"hover"} placement="right">
        ...
        {child.categories.length > 0 && (
          ...
          >
            {child.categories &&
              child.categories.map((child, idx) => {
        ...
        <Stack direction={"column"} spacing={"-0.5"}>
          ...
          {product.countInStock <= 0 ? (
            ...
            <Stack direction={"row"} py={2}>
              ...
              <Text fontSize={"xs"} fontWeight={"bold"} pt={2}>
