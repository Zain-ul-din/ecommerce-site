...
export function Category({
  ...
  return (
    <>
      <Link
        href={
          mode === "category" ? `/category/${name}` : `/category/${name}/${id}`
        }
      >
        <Stack
          maxW={{ lg: 270, base: 170 }}
          w={"100%"}
          m={{ xl: 1, lg: 2, md: 1, base: "0.5" }}
          border={1}
        ...
        >
          <Box py={1}>
            <Text
              pl={1}
              fontSize={{ lg: "2xl", md: "1xl", sm: "sm", base: "sm" }}
            >
              {name}
            </Text>
          </Box>
