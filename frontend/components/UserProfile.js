    ...
    <Center py={6} mt={10}>
      ...
      >
          ...
          <Popover>
            ...
            <PopoverContent bg={"white"} border={"1px solid black"}>
              ...
              <Stack p={1}>
                ...
                <Button
                  colorScheme={
                    userName && userName.trim().length > 2 ? `green` : `red`
                  }
                  onClick={async (e) => {
        ...
        <Stack align={"center"} justify={"center"} direction={"row"} mt={6}>
          <Text>Sign With : </Text>
          <Badge px={2} py={1} colorScheme={"whatsapp"} fontWeight={"400"}>
            {user.auth}
          </Badge>
        </Stack>
        ...
        <Center mt={4}>
          <Stack direction={"row"} spacing={2}>
            <Switch
              size={"sm"}
              colorScheme={userStatus.isAdmin ? "green" : "red"}
