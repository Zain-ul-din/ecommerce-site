...
async function post (req , res) {
    ...
    const newReview = await prisma.review.create ({
        data : {
            ...
            updatedAt : isValidDate(new Date(review.updatedAt)) ?review.updatedAt : new Date().toString(),
    ...
    else res.send(Object.assign(RESPONSE , { data : newReview , status : HTTP_RESPONSE.created}))
}
