...
async function getUnique(req, res) {
  const category = await prisma.superCategory.findMany({
...
async function post(req, res) {
  ...
  const newCategory = await prisma.superCategory
    .create({
      data: {
        name: category.name,
...
async function updateUnique(req, res) {
  ...
  const updatedCategory = await prisma.superCategory
    .update({
      where: { id: id },
      data: {
        name: category.name,
